...
class AmptiveAnimatedPaddingOnPictureWidget extends StatefulWidget {
  ...
  @override
  State<AmptiveAnimatedPaddingOnPictureWidget> createState() =>
      _SizeAnimationState();
}

class _SizeAnimationState extends State<AmptiveAnimatedPaddingOnPictureWidget>
  ...
  Widget build(_) => AnimatedBuilder(
        ...
        builder: (_, __) => Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: AmptiveColors.orangeGradientColorA, width: 2)),
          child: ClipRRect(
            borderRadius: BorderRadius.circular(35),
