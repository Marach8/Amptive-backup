        ...
        return BlocConsumer<RemoteUserDataCubit, ATAppState<UserData>>(
            ...
            builder: (BuildContext context, ATAppState<UserData> state) {
              return BlocBuilder<LocalUserDataCubit, ATAppState<CachedUserData>>(
                builder: (BuildContext context, ATAppState<CachedUserData> userData) {
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            _MenuItem(
                                ...
                                onTap: () async {
                                  final String? newUsername = await context.pushNamed(
                                      ...
                                      extra: userData?.username ?? 'AlieuBaba');
                            ...
                            _MenuItem(
                                title: ATStrings.BIO,
                                value: userData?.bio ?? 'Author of UNTAMED & LOVE IS IN THE AIR',
                                onTap: () async {
                            ...
                            _MenuItem(
                                ...
                                isLink: true,
                                value: userData?.instagramUrl?? 'www.instagram.com/alieubaba1',
                                onTap: () async {
                                  ...
                                  if (newInstagramUrl != null && context.mounted) {
                                    context
                                        .read<RemoteUserDataCubit>()
                                        .updateProfile(instagramUrl: newInstagramUrl);
                                  }
                                }),
                            _MenuItem(
                                title: 'X',
                            ...
                            _MenuItem(
                                ...
                                isLink: true,
                                value: userData?.linkedinUrl ??'www.linkedIn.com/alieubaba',
                                onTap: () async {
                                  ...
                                  if (newLinkedInUrl != null && context.mounted) {
                                    context
                                        .read<RemoteUserDataCubit>()
                                        .updateProfile(linkedinUrl: newLinkedInUrl);
                                  }
                                }),
                            _MenuItem(
                                title: ATStrings.WEBSITE,
                                isLink: true,
                                value: userData?.websiteUrl ?? 'www.palbucks.co',
                                onTap: () async {
                                  ...
                                  if (newWebsiteUrl != null && context.mounted) {
                                    context
                                        .read<RemoteUserDataCubit>()
                                        .updateProfile(websiteUrl: newWebsiteUrl);
                                  }
                                }),
                            const SizedBox(height: 15),
                            const ATDivider(),
