...
class EditSocialsScreen extends StatefulWidget {
  const EditSocialsScreen(
      {super.key, required this.initialLink, required this.socialName});
...
class _EditSocialsScreenState extends State<EditSocialsScreen> {
  ...
  void _handleTextChange() {
    final bool isDifferent =
        _cntrl.text.isNotEmpty && (_cntrl.text.trim() != widget.initialLink);
  ...
  Widget build(BuildContext context) {
    ...
    hintText = ATStrings.enterLink(
        '${widget.socialName} ${ATStrings.PROFILE.toLowerCase()}');
