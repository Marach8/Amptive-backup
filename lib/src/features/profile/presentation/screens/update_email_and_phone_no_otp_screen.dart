...
class EmailAndPhoneNoOTPScreenParams {
  const EmailAndPhoneNoOTPScreenParams({
...
class UpdateEmailAndPhoneNoOtpScreen extends StatefulWidget {
  const UpdateEmailAndPhoneNoOtpScreen({
    super.key,
    required this.params,
  });
  final EmailAndPhoneNoOTPScreenParams params;

  @override
  State<UpdateEmailAndPhoneNoOtpScreen> createState() => _UpdateEmailAndPhoneNoOtpScreenState();
}

class _UpdateEmailAndPhoneNoOtpScreenState extends State<UpdateEmailAndPhoneNoOtpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: <SingleChildWidget>[
        BlocProvider<VerifyEmailAndPhoneNoOtpCubit>(create: (_) => VerifyEmailAndPhoneNoOtpCubit()),
        BlocProvider<UpdateEmailAndPhoneNumberCubit>(create: (_) => UpdateEmailAndPhoneNumberCubit()),
      ],
          ...
          body: Padding(
            ...
            child: Form(
              child: Column(
                ...
                children: <Widget>[
                  BlocListener<UpdateEmailAndPhoneNumberCubit, ATAppState<String>>(
                            ...
                            children: <InlineSpan>[
                              ...
                              TextSpan(
                                ...
                                recognizer: _tapGestureRecognizer
                                  ..onTap = () {
                                    context
                                        .read<UpdateEmailAndPhoneNumberCubit>()
                                        .sendEmailAndPhoneOtp(param: <String, dynamic>{
                                      'email': widget.params.identifier,
                                      'phone_number': widget.params.identifier,
                                    });
            ...
            return Padding(
              ...
              child: ValueListenableBuilder<
                  ...
                  builder: (_,
                    ...
                    return BlocConsumer<VerifyEmailAndPhoneNoOtpCubit, ATAppState<dynamic>>(
                      ...
                      builder: (BuildContext context,
                        ...
                        return ATPlainElevatedBtn(
                          ...
                          onPressed: shouldEnable
                              ? () {
                                  context.read<VerifyEmailAndPhoneNoOtpCubit>().verifyOtp(
