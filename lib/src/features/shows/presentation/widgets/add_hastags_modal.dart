        ...
        children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Opacity(
                                opacity: 0.0,
                                child: Text('3 selected',
                                    style: Theme.of(context)
                                        .textTheme
                                        .titleSmall
                                        ?.copyWith(color: ATColors.hexC2C2C2)),
                              ),
                              Text('${ATStrings.addHashtags}s',
                              ...
                              BlocSelector<
                                  ...
                                  selector: ((
                                      ...
                                      state.$2,
                                  builder: (_,
                                      List<ATHashtag<bool>> selectedHashtags) {
                                    return Text(
          ...
          Positioned(
            ...
            child: BlocSelector<
                    ...
                    List<ATHashtag<bool>>>(
                selector:
                    ((List<ATHashtag<bool>>, List<ATHashtag<bool>>) state) =>
                        state.$2,
                builder: (_, List<ATHashtag<bool>> selectedHashtags) {
                  final bool activateBtn = selectedHashtags
                      .any((ATHashtag<bool> hashtag) => hashtag.title != null);

                  return ATBlurredBgBtn(
                    onPressed: activateBtn ? () => dContext.pop() : null,
                    btnTitle: '${ATStrings.addHashtags}s',
                  );
                }),
          )
        ],
