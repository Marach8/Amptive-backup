...
class _SocietyTabsWidgetState extends State<SocietyTabsWidget> {
  ...
  static const List<String> _tabs = <String>[ATStrings.ALL, ATStrings.SHOWS, ATStrings.EVENTS];
      ...
      children: _tabs.map(
        (String tab){
          ...
          return ATContainer(
            ...
            radius: 20, duration: 100,
            margin: const EdgeInsets.only(left: 15),
            color: isSelected ? 
              ATColors.white : ATColors.hex9E9E9E.withValues(alpha: 0.3),
