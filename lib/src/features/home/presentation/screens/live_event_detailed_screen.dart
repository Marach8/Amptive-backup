                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    BlocBuilder<EventDetailCubit, ATAppState<HostedEvent>>(
                                      builder: (context, state) {
                                        final event = context.read<EventDetailCubit>().currentEventDetail;
                                        final description = event?.description ?? homeFeedItem?.description;
                                        
                                        final bool isLoading = state is InitialState<HostedEvent> || state is LoadingState<HostedEvent>;
