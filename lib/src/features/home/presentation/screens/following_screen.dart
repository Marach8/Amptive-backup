...
class ATFollowedPrograms extends StatefulWidget {
  const ATFollowedPrograms({
    super.key,
  });

  @override
  State<ATFollowedPrograms> createState() => _ATFollowedProgramsState();
}

class _ATFollowedProgramsState extends State<ATFollowedPrograms> {
  @override
  void initState() {
    super.initState();
    context.read<FollowingFeedCubit>().fetchFeed();
  }

  Future<void> _onRefresh() async {
    await context.read<FollowingFeedCubit>().refreshFeed();
  }
        ...
        body: SafeArea(
          ...
          child: NotificationListener<ScrollNotification>(
            ...
            child: NestedScrollView(
                ...
                body: BlocBuilder<FollowingFeedCubit, MockFeedState>(
