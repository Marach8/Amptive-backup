...
class ATScheduledPrograms extends StatefulWidget {
  const ATScheduledPrograms({
    super.key,
  });

  @override
  State<ATScheduledPrograms> createState() => _ATScheduledProgramsState();
}

class _ATScheduledProgramsState extends State<ATScheduledPrograms> {
  @override
  void initState() {
    super.initState();
    context.read<ScheduledFeedCubit>().fetchFeed();
  }

  Future<void> _onRefresh() async {
    await context.read<ScheduledFeedCubit>().refreshFeed();
  }
        ...
        body: SafeArea(
          ...
          child: NotificationListener<ScrollNotification>(
            ...
            child: NestedScrollView(
                ...
                body: BlocBuilder<ScheduledFeedCubit, MockFeedState>(
