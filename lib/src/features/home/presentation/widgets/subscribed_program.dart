...
class SubscribedProgram extends StatefulWidget {
  const SubscribedProgram({super.key, this.isEvent = false});
  final bool isEvent;

  @override
  State<SubscribedProgram> createState() => _SubscribedProgramState();
}

class _SubscribedProgramState extends State<SubscribedProgram> {
