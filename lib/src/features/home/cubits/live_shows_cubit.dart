...
class LiveShowsCubit extends Cubit<ATAppState<dynamic>> {
  LiveShowsCubit({HomeRepo? mockHomeRepo})
  ...
  Future<void> fetchLiveShows() async {
    ...
    try {
      final ApiResponse<dynamic> response = await homeRepo.fetchLiveShows(
        page: 0,
        pageSize: 20,
        refresh: false,
      );
      ...
      emit(FailureState<dynamic>('Unable to get live shows: $e'));
    }
  }
}
