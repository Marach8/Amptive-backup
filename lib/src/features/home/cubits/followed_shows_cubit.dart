...
class FollowedShowsCubit extends Cubit<ATAppState<dynamic>> {
  FollowedShowsCubit({HomeRepo? mockHomeRepo})
  ...
  Future<void> fetchFollowedShows() async {
    ...
    try {
      final ApiResponse<dynamic> response = await homeRepo.fetchFollowedShows(
        page: 0,
        pageSize: 20,
        refresh: false,
      );
      ...
      emit(FailureState<dynamic>('Unable to get followed shows: $e'));
    }
  }
}
