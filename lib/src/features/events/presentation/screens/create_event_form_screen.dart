...
class __SubWidgetState extends State<_SubWidget> {
  ...
  final ValueNotifier<(bool?, ScheduleBtnOnTap)> _activateBtn =
      ValueNotifier<(bool?, ScheduleBtnOnTap)>(
          (false, ScheduleBtnOnTap.goLive));
                                            ...
                                            final ScheduleDateResult? result =
                                                await context.pushNamed(
                                                    ...
                                                    extra: SelectScheduleDataScreenEntryParams(
                                                        ...
                                                        programName: 'Event',
                                                        incomingDate:
                                                            _scheduleDate)) as ScheduleDateResult?;
                                            if (result == null) {
                                              return; // cancelled
                                            }
                                            if (result.removed) {
                    ...
                    children: <Widget>[
                          ...
                          return CreateProgramSelectionItem(
                            ...
                            onTap: () async {
                              final String? newCapacity =
                                ...
                                context: context,
                                currentCapacity: selectedCapacity == 'Unlimited'
                                    ? null
                                    : selectedCapacity,
                              );
                              setter(() => selectedCapacity =
                                  newCapacity ?? 'Unlimited');
                            },
                          );
                        }),
                      ),
                      ...
                      Padding(
                        ...
                        child:
                            StatefulBuilder(builder: (_, StateSetter setter) {
                          String descriptionText =
                              ATStrings.choose2AllowWhispers;
                ...
                listener: (_, ATAppState<LiveProgramEntryToken> state) async {
                  if (state is SuccessState<LiveProgramEntryToken>) {
                    ...
                    final HostedEvent? hostedEvent =
                        context.read<CreateEventCubit>().currentEvent;
                    ...
                    context.read<CreateEventCubit>().createEvent(
                          createEventModel: CreateEventPayload(
                            ...
                            eventType: accessTypeData.accessType ==
                                ...
                                ? 'free'
                                : 'paid',
                            handRaising: selectedPermission ==
                                HandRaisingPermission.allow,
                            price: accessTypeData.accessType ==
                                    ProgramAccessType.free
                                ? 0.01
                    ...
                    onPressed: value.$1 == false
                        ...
                        : () {
                            ...
                            if (currentOnTap ==
                                ...
                                _scheduleDate == null) {
                              errorMessage =
                                  'Please choose a schedule date/time for this event';
                            }
