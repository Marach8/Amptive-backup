...
class _AddLinkWidgetState extends State<_AddLinkWidget> with ATValidators{
  ...
  void initState(){
    ...
    _activateBtn = ValueNotifier<bool>(widget.linkName != null && widget.linkUrl != null);
  }
                ...
                return ATPlainElevatedBtn(
                  onPressed: shouldActivate ? (){
                    if(_formKey.currentState?.validate() ?? false){
                      context.pop((_linkNameCntrl.text.trim(), _linkUrlCntrl.text.trim()));
                    }
                  } : null,
