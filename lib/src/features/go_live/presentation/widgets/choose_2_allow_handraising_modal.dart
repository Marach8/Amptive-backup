...
Future<String?> choose2AllowHandRaisingModal(
    {required BuildContext context, required String initialHandRaising}) async {
  return await showModalBottomSheet<String>(
    ...
    builder: (BuildContext dContext) {
      return BlocProvider<_HandRaisingBloc>(
        create: (_) =>
            _HandRaisingBloc()..initializeHandRaising(initialHandRaising),
                  ...
                  children: <Widget>[
                    ...
                    ATRichText(
                      items: <String, TextStyle>{
                        ATStrings.U_WILL_HAVE_ACCESS_2_MODERATION_TOOLS:
                    ...
                    Expanded(
                      ...
                      child: BlocBuilder<_HandRaisingBloc, String?>(
                        ...
                        final bool shouldNotAllow =
                            state == ATStrings.DONT_ALLOW;
...
class _HandRaisingBloc extends Cubit<String?> {
  ...
  void chooseHandRaising(String? type) => emit(type);
