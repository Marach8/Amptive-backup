...
Future<void> showFollowHostOrCohostDialog(
  ...
  return await showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return BlocProvider<FollowCreatorCubit>(
          create: (_) => FollowCreatorCubit(),
          child: ClipRRect(
            ...
            child: Container(
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        BlocBuilder<FollowCreatorCubit,
                                ATAppState<FollowResponseModel>>(
                            builder:
                                (_, ATAppState<FollowResponseModel> state) {
                          final bool isLoading =
                              state is LoadingState<FollowResponseModel>;
                          final bool isSuccess =
                              state is SuccessState<FollowResponseModel>;
                          final bool isFollowing = isSuccess &&
                              (state.newData?.isFollowing ?? false);
                          final bool notFollowing = !isFollowing ||
                              state is InitialState<FollowResponseModel>;
