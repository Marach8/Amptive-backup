...
class HashtagServiceBloc
    extends Cubit<(List<ATHashtag<bool>>, List<ATHashtag<bool>>)> {
  ...
  void addHashtag(ATHashtag<bool> incomingHashtag) {
    final List<ATHashtag<bool>> currentHashtags =
        List<ATHashtag<bool>>.from(state.$2);
  ...
  void searchHashtags(String searchKey) {
    final List<ATHashtag<bool>> filterHashtags = initialHashtags
        .where((ATHashtag<bool> hashtag) =>
