                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                          spacing: 15,
                          children: paymentMethods.entries.indexed
                              .map(((int, MapEntry<String, String>) entry) {
                            return InkWell(
                              borderRadius: BorderRadius.circular(50),
                              onTap: () => context
                                  .read<_PaymentMethodBloc>()
                                  .setPaymentMethod(entry.$2.value),
                              child: ATContainer(
