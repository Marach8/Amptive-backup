        ...
        child: Builder(builder: (BuildContext context) {
          return Scaffold(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  BlocBuilder<_EnterAccountNoBloc, (String?, int?)>(
                      buildWhen: ((String?, int?) prev, (String?, int?) curr) =>
                          prev.$2 != curr.$2,
                  ...
                  BlocSelector<_EnterAccountNoBloc, (String?, int?), int?>(
                      ...
                      builder: (_, int? state) {
                        if (state == null) {
                          ...
                          final String? name =
                              context.read<_EnterAccountNoBloc>().state.$1;
                          return Text(
                            name ?? '',
                            style: context.textTheme.bodySmall
                                ?.copyWith(fontSize: ATSizes.size11),
            ...
            bottomNavigationBar: Padding(
              ...
              child: BlocSelector<_EnterAccountNoBloc, (String?, int?),
                      String?>(
                              ...
                              if (context.mounted) {
                                final String? amount = await context.pushNamed(
                                  ...
                                  extra: TransactionAmountScreenParams(
                                      ...
                                      title:
                                          '${ATStrings.withdraw} to ${bankDetail.accountName.toUpperCase()}',
                                      slidingNotif:
                                          ATStrings.AMPTIVE_WITHDRAWAL_CHARGES,
                                      btnTitle: ATStrings.enterPin,
                                      flushBarNotif: (shouldSave ?? false)
                                          ? ATStrings.BANK_DETAIL_SAVED
                                          : null),
                                ) as String?;
