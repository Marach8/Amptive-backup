...
class ATSelectRecipientScreen extends StatefulWidget {
  ...
  @override
  State<ATSelectRecipientScreen> createState() =>
      _ATSelectRecipientScreenState();
}
              ...
              child: NestedScrollView(
                ...
                headerSliverBuilder: (_, __) => <Widget>[
                  const ATSliverAppBar(
                    titleText: ATStrings.transferFunds,
                  ),
                            ...
                            return ATTextFormField(
                              ...
                              suffixIcon: showCancelIcon
                                  ? IconButton(
                                      onPressed: () => setter(() {
                                        context
                                            .read<RecentRecipientsBloc>()
                                            .add(ResetRecipientsEvent());
                                        _cntrl.clear();
                              ...
                              onChanged: (String text) {
                                ...
                                ATHelperFuncs.callDebouncer(500, () {
                                  ...
                                  context
                                      .read<RecentRecipientsBloc>()
                                      .add(SearchRecentRecipients(text));
                                });
                              },
                            );
                          }),
                      ...
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              ATStrings.TRY_SEARCHING_4_USER,
                              maxLines: 2,
                              style: Theme.of(context)
                                  .textTheme
                                  .titleMedium
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (_, int index) {
                          final ObjectWithNotifier<Host> recipient =
                              state.recipients.elementAt(index);
              ...
              return Padding(
                ...
                child: BlocBuilder<RecentRecipientsBloc, RecentRecipientsState>(
                  ...
                  return ATPlainElevatedBtn(
                    onPressed: (state is RecentRecipientsData &&
                        ...
                        ? () async {
                            ...
                            await context.pushNamed(
                                ...
                                extra: TransactionAmountScreenParams(
                                  ...
                                  title:
                                      '${ATStrings.transferFunds} to ${recipient.obj.name ?? ''}',
                                  slidingNotif:
                                      ATStrings.amptiveTransferCharges,
                                  btnTitle: ATStrings.enterPin,
                                  recipientProfileUrl:
                                      recipient.obj.profilePicture ?? '',
...
class _UserWithTrailingRadio extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () =>
          context.read<RecentRecipientsBloc>().add(SelectRecipient(user)),
      child: Padding(
        ...
        child: Row(
          children: <Widget>[
            ...
            BlocBuilder<RecentRecipientsBloc, RecentRecipientsState>(
                builder: (_, RecentRecipientsState state) {
              final ObjectWithNotifier<Host>? recipient =
                  (state as RecentRecipientsData).selectedRecipient;
              final bool isSelected =
                  recipient != null && recipient.obj.name == user.obj.name;
