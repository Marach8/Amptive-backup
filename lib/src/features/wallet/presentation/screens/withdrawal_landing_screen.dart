...
class ATWithdrwalLandingScreen extends StatelessWidget {
  ...
  static Map<String, List<String>> map = <String, List<String>>{
    ATImgStrings.WIRE_TRANSFER: <String>[
      ATStrings.WIRE_TRSF,
      ATStrings.WIRE_TRSF_DESC
    ],
        ...
        child: Builder(builder: (BuildContext context) {
          return Scaffold(
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    spacing: 10,
                    children: map.entries.indexed
                        .map(((int, MapEntry<String, List<String>>) entry) {
                      return Expanded(
            ...
            bottomNavigationBar: Padding(
              ...
              child: BlocBuilder<_PrivateBloc, int?>(builder: (_, int? state) {
                return ATPlainElevatedBtn(
                  onPressed: state == null
                      ? null
                      : () => context
                          .pushReplacementNamed(ATRoutes.SELECT_BANK_COUNTRY),
