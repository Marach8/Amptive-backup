...
class VerifyResetPasswordOtpCubit extends Cubit<ATAppState<dynamic>> {
  ...
  Future<void> verifyResetPasswordOtp({
   required Map<String, dynamic> param,
    ...
    try {
      final ApiResponse<dynamic> response = await authRepo.verifyResetPasswordOtp(param: param);
      response.when(
