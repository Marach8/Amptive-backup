          ...
          children: (eachWeek ?? <DateTime?>[])
            ...
            return Column(
              ...
              children: <Widget>[
                ...
                if (day.value != null)
                  BlocBuilder<SelectedCalenderDateBloc, DateTime?>(
                    builder: (_, DateTime? state) {
                      final bool isSelected = state == day.value;
                      return ATContainer(
                        onTap: () {
                          context
                              .read<SelectedCalenderDateBloc>()
                              .pickADate(day.value);
                        ...
                        child: FittedBox(
                          ...
                          child: Text(
                            ...
                            style: Theme.of(context)
                                .textTheme
                                .titleLarge
                                ?.copyWith(fontSize: ATSizes.size18),
                          ),
                        ),
                      );
                    },
