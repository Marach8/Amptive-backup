        ...
        Expanded(
          child: ListView.builder(
              ...
              itemBuilder: (_, int listIndex) {
                final MapEntry<DateTime, List<CalenderProgram>> programs =
                    _map.entries.elementAt(listIndex);
                ...
                return StickyHeaderBuilder(
                  ...
                  content: Padding(
                    ...
                    child: Column(
                      ...
                      spacing: 15,
                      children: programs.value.map((CalenderProgram program) {
...
final Map<DateTime, List<CalenderProgram>> _map =
    <DateTime, List<CalenderProgram>>{
...
class _CalenderProgramDisplay extends StatelessWidget {
  const _CalenderProgramDisplay({required this.program});
