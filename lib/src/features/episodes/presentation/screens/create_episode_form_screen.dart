      ...
      providers: <SingleChildWidget>[
        ...
        BlocProvider<BgImageCubit>(
            create: (_) => BgImageCubit(
                initialImage: showData.coverUrl ?? PreparedCoverArt.path)),
        ...
        BlocProvider<SelectedHashTagsCubit>(
            create: (_) =>
                SelectedHashTagsCubit(initialHashtags: showData.tags)),
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                      onTap: () async {
                                        ...
                                        final ScheduleDateResult? result =
                                            await context.pushNamed(
                                                    ATRoutes
                                                        .selectScheduleDateScreen,
                                                    extra: SelectScheduleDataScreenEntryParams(
                                                        selectedBgImage: context
                                                            .read<BgImageCubit>()
                                                            .state
                                                            .$2,
                                                        incomingBgImageUrl:
                                        ...
                                        if (result.removed) {
                                          ...
                                          _activateBtn.value = (
                                            _activateBtn.value.$1,
                                            ScheduleBtnOnTap.scheduleEvent
                                          );
                                        }
                                      },
                                      ...
                                      child: SizedBox(
                                        ...
                                        height: 44,
                                        child: Center(
                                          child: SvgPicture.string(ATImgStrings
                                              .createEpisodeScheduleIconSvg),
                                        ),
                                      )),
                                )
                              ],
                ...
                child: Column(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Center(
                        child: ClipSmoothRect(
                          ...
                          child: ATImgLoader(
                            imgPath: widget.showData.coverUrl ??
                        ...
                        return CreateProgramSelectionItem(
                          ...
                          onTap: () async {
                            final String? enteredDescription =
                              ...
                              hintText:
                                  'Give listeners a preview of this episode',
                        ...
                        return ATScalingSwitcher(
                            ...
                            child: selectedCommunity == null
                                ? CreateProgramSelectionItem(
                                    ...
                                    onTap:
                                        () {}, // Community cannot be changed on episodes
                                  )
                                : SelectedCommunityWidget(
                                    selectedCommunity: selectedCommunity!,
                                    onClose:
                                        null, // Community cannot be changed on episodes
                    ...
                    Padding(
                      padding: const EdgeInsets.fromLTRB(15, 0, 15, 10),
                      child: StatefulBuilder(builder: (_, StateSetter setter) {
                        final String accessTypeDescText = getAccessTypeDescText(
                          ...
                          onTap: () async {
                            final ProgramAccessTypeSelectionData?
                                ...
                                await showAudienceAccessTypeModal(
                                    context: context,
                                    initialAccessTypeData: accessTypeData);
                            setter(() {
                    ...
                    Padding(
                      ...
                      child: StatefulBuilder(builder: (_, StateSetter setter) {
                        ...
                        if (selectedHandRaisePermission ==
                          ...
                          onTap: () async {
                            final HandRaisingPermission? newPermission =
                                await showHandRaisingPermissionModal(
                                    context: context,
                                    initialPermission:
                                        selectedHandRaisePermission);
                            setter(() =>
                                selectedHandRaisePermission = newPermission);
                          },
                        );
                      }),
                    ),
                    ...
                    Padding(
                      ...
                      child: StatefulBuilder(builder: (_, StateSetter setter) {
                        ...
                        if (selectedWhispersPermission ==
                            WhispersPermission.allow) {
                          descriptionText = ATStrings.turnedOn;
                        } else if (selectedWhispersPermission ==
                        ...
                        return CreateProgramSelectionItem(
                          description: descriptionText,
                          descStyle:
                              descriptionText == ATStrings.choose2AllowWhispers
                                  ? null
                                  : context.textTheme.bodySmall,
                          onTap: () async {
                            final WhispersPermission? newPermission =
                                await showWhispersPermissionModal(
                                    context: context,
                                    initialPermission:
                                        selectedWhispersPermission);
                            setter(() =>
                                selectedWhispersPermission = newPermission);
                          },
                        );
                      }),
                    ),
                ...
                listener: (_, ATAppState<LiveProgramEntryToken> state) async {
                  if (state is SuccessState<LiveProgramEntryToken>) {
                    ...
                    final Episode? episode =
                        context.read<CreateEpisodeCubit>().currentEpisodeDetail;
                    final bool? didGoLive = await context.pushNamed<bool>(
                      ...
                      extra: LiveProgramData(
                        ...
                        roomParticipantId:
                            state.newData?.roomParticipantId ?? '',
                    ...
                    if (context.mounted && didGoLive == true) {
                      context.pop();
                    }
              ...
              BlocListener<CreateEpisodeCubit, ATAppState<Episode>>(
                listener: (_, ATAppState<Episode> state) async {
                  if (state is SuccessState<Episode>) {
                    ...
                    // scheduled-episodes screen shows it on next open. (This
                    // cubit only fires for the SCHEDULE path now; go-live
                    // episodes are created at the onboarding countdown.)
                    EpisodesOfAShowCubit.invalidate(
                        widget.showData.showId ?? '');
                    ...
                    final dynamic params = ProgramCreationSuccessScreenParams(
                      ...
                      subtitle:
                          'Share your episode link to build excitement and\n'
                    ...
                    onPressed: value.$1 == false
                        ...
                        : () async {
                            ...
                            if (_titleCntrl.text.trim().isEmpty) {
                              ...
                              errorMessage =
                                  'Please choose whether to allow hand-raising for this episode';
                            } else if (accessTypeData.accessType == null) {
                              errorMessage =
                                  'Please choose whether this episode is free or paid';
                            } else if (selectedWhispersPermission == null) {
                              errorMessage =
                                  'Please choose whether to allow whispers for this episode';
                            }
                            final ScheduleBtnOnTap currentOnTap =
                                _activateBtn.value.$2;
                            if (currentOnTap ==
                                    ScheduleBtnOnTap.scheduleEvent &&
                                _scheduleDate == null) {
                              errorMessage =
                                  'Please choose a schedule date/time for this episode';
                            }
                            ...
                            final CreateEpisodePayload payload =
                              ...
                              description: selectedDescription,
                              thumbnailUrl: widget.showData.coverUrl ??
                                  ATImgStrings.createShowPlaceholder,
                              ...
                              showTypeOverride: accessTypeData.accessType ==
                                  ...
                                  ? 'free'
                                  : 'paid',
                              priceOverride: accessTypeData.accessType ==
                                      ProgramAccessType.free
                                  ? 0.01
                              ...
                              allowHandRaising: selectedHandRaisePermission ==
                                  HandRaisingPermission.allow,
                              allowWhispers: selectedWhispersPermission ==
                                  WhispersPermission.allow,
                              scheduledFor:
                                  _scheduleDate?.toUtc().toIso8601String(),
                            );

                            if (shouldGoToGoLive) {
                              // Go-live: don't create anything yet. The episode is only
                              // created (and started) when the host commits at the
                              // onboarding countdown — abandoning leaves no orphan.
                              final bool? didGoLive =
                                  await context.pushNamed<bool>(
                                ATRoutes.goLiveOnboarding,
                                extra: PendingGoLiveEpisode(
