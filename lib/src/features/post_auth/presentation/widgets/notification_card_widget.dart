...
class NotifTile1 extends StatelessWidget {
  ...
  final double rightPicSize, leftPicSize,
  titleFontSize, subTitleFontSize, timeFontSize, horizMargin;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Container(
            height: leftPicSize, width: leftPicSize,
              ...
              children: <Widget>[
                Expanded(
                  child: _TitleAndSubTitle(
                    ...
                    subtitle: subtitle, subTitleFontSize: subTitleFontSize
                  ),
                ),
                _TimeAndPicture(
                  key: ValueKey<String>(time),
                  time: time, timeFontSize: timeFontSize,
...
class _TimeAndPicture extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      mainAxisSize: MainAxisSize.min, spacing: 3,
      children: <Widget>[
        Text(
          time,
        ...
        ClipRRect(
          ...
          child: ATImgLoader(
            height: rightPicSize, width: rightPicSize,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        Text(
          subtitle, maxLines: 4, overflow: TextOverflow.ellipsis,
          style: context.textTheme.titleSmall!.copyWith(
