...
class ScaleOnPressWidget extends StatefulWidget {
  ...
  @override
  State<ScaleOnPressWidget> createState() => _ScaleOnPressWidgetState();
}
...
class _ScaleOnPressWidgetState extends State<ScaleOnPressWidget>
  ...
  @override
  void didUpdateWidget(covariant ScaleOnPressWidget oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (oldWidget.scaleDownTo != widget.scaleDownTo) {
      _scaleAnimation = Tween<double>(begin: 1.0, end: widget.scaleDownTo).animate(
        CurvedAnimation(parent: _controller, curve: Curves.easeInOut),
      );
    }
