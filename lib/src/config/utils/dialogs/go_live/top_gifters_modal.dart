                      ...
                      child: ATScrollBar(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, int listIndex){
                            ...
                            final ObjectWithNotifier<Host> gifter = getHostList().elementAt(listIndex - 1);                             
              ...
              child: BackdropFilter(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    ATContainer(
                      onTap: (){},
                      radius: 40, color: ATColors.hex307FE2,
...
class _GiftsDescColumn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisSize: MainAxisSize.min, spacing: 24,
      children: <Widget>[
        Align(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: <Widget>[
              const ATImgLoader(imgPath: ATImgStrings.HOST_GIFT_ICON, height: 30, width: 30,),
        ...
        Text(
          ...
          style: context.textTheme.labelSmall?.copyWith(
            color: ATColors.hexC2C2C2, letterSpacing: 0
          ),
        ),
        Text(
