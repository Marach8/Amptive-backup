                ...
                child: Column(
                  ...
                  children: <Widget>[
                      ...
                      BlocSelector<_PrivatBloc, (int?, bool), int?>(
                          ...
                          builder: (_, int? state) {
                            return _PrivateWidget(
                              ...
                              isSelected: state == 0,
                              amount: '5,000',
                              onSelected: () => blocContext
                                  .read<_PrivatBloc>()
                                  .selectChoice(state == 0 ? null : 0),
                              leadingOntap: () {},
                            );
                          }),
                    const SizedBox(height: 15),
                    BlocSelector<_PrivatBloc, (int?, bool), int?>(
                        ...
                        builder: (_, int? state) {
                          return _PrivateWidget(
                            onTapTitle: ATStrings.setupCohostFee,
                            title: ATStrings.ACCEPT_WITHOUT_FEE,
                            subtitle: ATStrings.ACCEPT_WITHOUT_FEE_DESC,
                            isSelected: state == 1,
                            onSelected: () => blocContext
                                .read<_PrivatBloc>()
                                .selectChoice(state == 1 ? null : 1),
                            leadingOntap: coHostFee == null
                                ? () => dialogContext.pop((3, false))
                                : null,
                          );
                        }),
                    const SizedBox(height: 15),
                    ...
                    Align(
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          ...
                          onTap: () =>
                              blocContext.read<_PrivatBloc>().rememberChoice(),
                          child: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: <Widget>[
                              ...
                              Text(ATStrings.REMEMBER_CHOICE_4_HOST,
                                  maxLines: 2,
                    ...
                    Text(ATStrings.AMPTIVE_CHARGES_4_CREATORS,
                        maxLines: 2,
                        style: Theme.of(context).textTheme.labelSmall?.copyWith(
...
class _PrivateWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ATContainer(
        ...
        border: isSelected
            ? Border.all(color: ATColors.hex307FE2, width: 0.5)
            : null,
